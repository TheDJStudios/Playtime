...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> HAND_SCANNER_VTWO_BLUE = BLOCKS.register("hand_scanner_vtwo_blue", HandScannerVTwoBlue::new);
    ...
    public static final RegistryObject<Item> HAND_SCANNER_VTWO_BLUE_ITEM = ITEMS.register("hand_scanner_vtwo_blue", () -> new BlockItem(HAND_SCANNER_VTWO_BLUE.get(), new Item.Properties()));
    ...
    public static void addCreative(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS) {
            ...
            event.accept(HAND_SCANNER_VTWO_BLUE_ITEM);
